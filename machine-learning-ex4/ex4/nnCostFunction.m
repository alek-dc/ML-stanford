...
Theta1_grad = delta_cap1/m + (lambda/m)*[zeros(size(Theta1,1), 1) Theta1(:, 2:end)];
Theta2_grad = delta_cap2/m + (lambda/m)*[zeros(size(Theta2,1), 1) Theta2(:, 2:end)];
